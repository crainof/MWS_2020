...
## Overview
Webサイトの登録画面における個人の情報漏洩時のリスクを通知するアプリケーション

## Description
 
 Japan Network Security Association が提示する個人情報漏洩時の損害賠償額算出モデル[1]を参考とした、
 登録する情報の価値を定量的に算出する独自モデルにより、情報漏洩時のリスクを確認することができる。

 次の機能が実装されています。
  - 入力されたURLの会員登録ページをスクレイピングし、情報漏洩時のリスクを計算する


  参考：2018年　情報セキュリティインシデントに関する調査報告書　別紙　第一版（https://www.jnsa.org/result/incident/2018.html）
...
<img src = "https://user-images.githubusercontent.com/58422123/94141930-763ea800-fea8-11ea-967a-f1bc7936cd2f.png" width = 80%>
	...
	- 社会的責任度 : 勤務先情報を登録する場合 2, 登録しない場合 1